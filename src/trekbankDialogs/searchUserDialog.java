 ...
 * @author Johnny
 */
public class searchUserDialog extends java.awt.Dialog {

    private static ArrayList<User> selectedUsers = new ArrayList<User>();
    /**
     * Creates new form searchProjectDialog
     */
    private searchUserDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        ...
        setLocation(new Point((screenSize.width - 260)/2, (screenSize.height - 412)/2));
    ...
    private void searchFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchFieldKeyReleased
        ...
        for (User a : Database.searchUserByName(searchField.getText(), caseInsensitive.isSelected())){
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        for (String s : resultField.getSelectedItems()){
            selectedUsers.add(Database.searchUserByExactName(s));
        }
        closeDialog(null);
     ...
     */
    public static ArrayList<User> showDialog(java.awt.Frame parent) throws NoUserSelectedException{
        searchUserDialog dialog = new searchUserDialog(parent, true);
