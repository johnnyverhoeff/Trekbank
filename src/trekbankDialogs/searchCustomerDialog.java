 ...
 * @author Johnny
 */
public class searchCustomerDialog extends java.awt.Dialog {

    private static ArrayList<Customer> selectedCustomers = new ArrayList<Customer>();
    /**
     * Creates new form searchProjectDialog
     */
    private searchCustomerDialog(java.awt.Frame parent, boolean modal, boolean multipleSelect) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        okButton.setText("Ok");
        okButton.setToolTipText("Als u op deze knop klikt worden de klanten gebruikt die u geselecteerd hebt");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(resultField, javax.swing.GroupLayout.DEFAULT_SIZE, 212, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void searchFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchFieldKeyReleased
        ...
        for (Customer a : Database.searchCustomerByName(searchField.getText(), caseInsensitive.isSelected())){
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        for (String s : resultField.getSelectedItems()){
            selectedCustomers.add(Database.searchCustomerByExactName(s));
        }
        closeDialog(null);
     ...
     */
    public static ArrayList<Customer> showDialog(java.awt.Frame parent, boolean multipleSelect) throws NoCustomerSelectedException{
        searchCustomerDialog dialog = new searchCustomerDialog(parent, true, multipleSelect);
        dialog.setVisible(true);
        if (selectedCustomers.isEmpty()){
            throw new NoCustomerSelectedException();
        } else {        
