 ...
 * @author Johnny
 */
public class searchProjectDialog extends java.awt.Dialog {

    private static ArrayList<Project> selectedProjects = new ArrayList<Project>();
    /**
     * Creates new form searchProjectDialog
     */
    private searchProjectDialog(java.awt.Frame parent, boolean modal, boolean multipleSelect) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        okButton.setText("Ok");
        okButton.setToolTipText("Als u op deze knop klikt worden de project gebruikt die u geselecteerd hebt");
        ...
        cancelButton.setToolTipText("Als u deze knop gebruikt wordt er geen project geselecteerd en keert u terug naar waar u vandaan kwam");
    ...
    private void searchFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchFieldKeyReleased
        ...
        for (Project a : Database.searchProjectByName(searchField.getText(), caseInsensitive.isSelected())){
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        for (String s : resultField.getSelectedItems()){
            selectedProjects.add(Database.searchProjectByExactName(s));
        }
        closeDialog(null);
     ...
     */
    public static ArrayList<Project> showDialog(java.awt.Frame parent, boolean multipleSelect) throws NoProjectSelectedException{
        searchProjectDialog dialog = new searchProjectDialog(parent, true, multipleSelect);
